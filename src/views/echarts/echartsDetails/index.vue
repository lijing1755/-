<template>
  <div class="wrapper">
      <div class="myChart">
        <div id="myChartTwo"  :style="{width: '100%', height: '300px','margin-top':'20px'}"></div>
      </div>
      <div class="myChart">
      ...
      <div class="piev">
        ...
        <div id="pie" :style="{width: '100%', height: '400px' , 'margin-top':'20px',padding:'10px 0px',background:'#fff'}"></div>
  ...
  methods: {
    ...
    drawLine(){//用户访问活动数据
         activityPvList().then(res => {
            let drawLineDate = res.data.activity_pv_list
